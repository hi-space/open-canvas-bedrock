...
export default function ModelSelector({
  ...
  // Group models by category instead of provider
  const modelsByCategory = allAllowedModels.reduce((acc, model) => {
    ...
    return acc;
  }, {} as Record<string, typeof allAllowedModels>);

  // Define category order
  const categoryOrder = ["Anthropic", "Amazon", "Meta", "DeepSeek", "Other"];
        ...
        <Command>
          <CommandList>
            {categoryOrder.map((category) => {
              ...
              return (
                <CommandGroup key={category} heading={category} className="w-full">
                  {models.map((model) => {
